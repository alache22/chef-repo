...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "lc3090-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/lc3090chef"
  #   chef.validation_client_name = "lc3090chef-validator"
  #   chef.validation_key_path = ".chef/lc3090chef-validator.pem"
  # end
end
